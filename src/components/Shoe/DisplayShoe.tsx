         ...
         Update
          ...
          >
            <Typography sx={{ p: 1 , paddingLeft: 1 }}> <UpdateShoe state= {this.props.state} sessionToken={this.props.sessionToken} updateToken= {this.props.updateToken} /></Typography>
              ...
              <TableCell sx = {{fontSize: 12, paddingLeft: 10, fontFamily: 'Hind'}} align="center">{myShoe.samePair}</TableCell>
              <TableCell sx = {{fontSize: 12, paddingLeft: 10, fontFamily: 'Hind'}} align="center">{myShoe.buyPrice}</TableCell>
              <TableCell sx = {{fontSize: 12, paddingLeft: 10, fontFamily: 'Hind'}} align="center">{myShoe.sellPrice}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
